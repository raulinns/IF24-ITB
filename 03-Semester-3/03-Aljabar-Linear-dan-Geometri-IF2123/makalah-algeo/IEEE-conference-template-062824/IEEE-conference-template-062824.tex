...
\title{Analisis Penggunaan Algoritma Neural Style Transfer untuk Sintesis Citra Artistik\\}

\author{\IEEEauthorblockN{Narendra Dharma Wistara M.}
\IEEEauthorblockA{\textit{Sekolah Teknik Elektro dan Informatika} \\
\textit{Institut Teknologi Bandung}\\
Bandung, Indonesia \\
\href{mailto:13524044@std.stei.itb.ac.id}{13524044@std.stei.itb.ac.id} \\
\href{mailto:andradaffamarpaung@gmail.com}{andradaffamarpaung@gmail.com} \\}
}
