...
*/
void printTreeIndent(BinTree p, int h, int current_indent) {
    if (!isTreeEmpty(p)) {
        /* Cetak indentasi */
        int i;
        ...
        /* Rekursif ke anak kiri dan kanan dengan indentasi bertambah */
        printTreeIndent(LEFT(p), h, current_indent + h);
        printTreeIndent(RIGHT(p), h, current_indent + h);
    }
}

void printTree(BinTree p, int h) {
    printTreeIndent(p, h, 0);
}
