...
class TaskManager {
  ...
  public:
     ...
     * @details This overload does not check uniqueness; duplicate policy is
    ...
    /**
     * @brief Updates title, priority, and duration for the first task matching
     * @p id.
     ...
     */
    void update(const string &id, const string &title, int priority,
                int duration);
    ...
    /**
     * @brief Prints tasks whose title contains @p keyword as a case-sensitive
     * substring.
