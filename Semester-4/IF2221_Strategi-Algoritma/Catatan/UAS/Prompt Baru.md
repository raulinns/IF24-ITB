...
```text
Nama mata kuliah: IF2221 Strategi Algoritma
Waktu tersisa: 12 Jam
Jenis ujian: UAS
Tanggal ujian: Rabu, 3 Juni 2026
```

### Capaian Pembelajaran Mata Kuliah (CPMK)

```text
CPMK1. Menyusun solusi masalah komputasi dengan berbagai strategi algoritma,
bergantung pada karakteristik persoalan, kemudian mendesain algoritma
penyelesaian masalah

CPMK2. Mengimplementasikan desain algoritma menjadi sebuah program
aplikasi

CPMK3. Menulis makalah ilmiah yang berisi hasil studi dan implementasi
penyelesaian masalah dengan menggunakan berbagai strategi algoritma.

CPMK4. Menulis laporan penyelesaian masalah komputasi yang diberikan di dalam tugas

CPMK5. Mendemokan aplikasi untuk mendapatkan feedback
```
...
```text
Sumber utama: https://notebooklm.google.com/notebook/f5275108-14fd-4eb0-ad25-2c6fa776e344
Boleh melengkapi dengan pengetahuan umum: Ya, selama terdapat relevansinya dengan materi. Tandai dengan footnote untuk bagian yang menggunakan pengetahuan umum.
```
...
Tambahkan subsection ini hanya apabila materi memiliki rumus, algoritma, pseudocode, atau prosedur formal yang penting. 
