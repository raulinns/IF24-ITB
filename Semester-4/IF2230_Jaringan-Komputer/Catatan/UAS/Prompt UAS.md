...
Nama atau identitas notebook NotebookLM: https://notebooklm.google.com/notebook/b703af0f-f21b-4bad-becb-1716c0049dda
Sumber utama yang diperkirakan relevan:

Boleh melengkapi dengan sumber eksternal: Ya
Tingkat kedalaman: Sangat Mendalam (Maksimum)
Perlu pseudocode: Ya
Perlu rumus: Ya
...
Mode pengerjaan: 2
[Pilih salah satu:
1.  Satu materi terlebih dahulu — setiap materi diproses secara individual dan hasilnya harus saya konfirmasi sebelum Anda melanjutkan. 

2. Seluruh materi sekaligus — setiap materi tetap diproses secara individual, tetapi Anda tidak perlu meminta konfirmasi di antara materi dan langsung menyerahkan proyek lengkap setelah semuanya selesai.] 
   
Nama materi yang dikerjakan sekarang: Transport Layer
[Wajib diisi apabila memilih mode Satu materi terlebih dahulu. Apabila memilih mode Seluruh materi sekaligus, kerjakan berdasarkan urutan Daftar Materi Ujian.] 
